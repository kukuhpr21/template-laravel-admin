...
@php
    ...
    $color = "bg-".$class."-200 focus:bg-".$class."-200";
    $classes = $color.' py-4 px-3 my-3 rounded-2xl focus:outline-none focus:ring-0 border-0 hover:drop-shadow-xl focus:drop-shadow-xl';
@endphp
